...
const CityDescriptions = {
    "default": <>
        <h1>Select a city to read more!</h1>
        <p>By selecting a city on the map, you can read more about what tourist attractions it offers and other useful information.</p>
    </>,
    "SZZ": <>
        <h1>Szczecin</h1>
        <p>
        ...
        <TextLink href="/cities/szczecin" shadowSize="medium">Read more about what Szczecin has to offer</TextLink>
    </>,
    "GDN": <>
        <h1>Gdańsk</h1>
        <p>
        ...
        <TextLink href="/cities/gdansk" shadowSize="medium">Read more about what Gdańsk has to offer</TextLink>
    </>,
    "POZ": <>
        <h1>Poznań</h1>
        <p>
        ...
        <TextLink href="/cities/poznan" shadowSize="medium">Read more about what Poznań has to offer</TextLink>
    </>,
    "WAW": <>
        <h1>Warsaw</h1>
        <p>
        ...
        <TextLink href="/cities/warszawa" shadowSize="medium">Read more about what Warsaw has to offer</TextLink>
    </>,
    "KRK": <>
        <h1>Kraków</h1>
        <p>
        ...
        <p>
            ...
            With a rich history, Kraków is offering a variaty of museums and buildings to be explored. An example could be the nearby Wieliczka Salt Mine or Saint Mary&apos;s Basilica.
        </p>
        <TextLink href="/cities/krakow" shadowSize="medium">Read more about what Kraków has to offer</TextLink>
    </>,
    "WRO": <>
        <h1>Wrocław</h1>
        <p>
        ...
        <TextLink href="/cities/wroclaw" shadowSize="medium">Read more about what Wrocław has to offer</TextLink>
    </>
}
